...
$diccionario = array(
    ...
    'form_actions' => array(
        'SET' => '/dwp_2023_pf_bmanuel/' . MODULO . SET_USER . '/',
        'GET' => '/dwp_2023_pf_bmanuel/' . MODULO . GET_USER . '/',
        'DELETE' => '/dwp_2023_pf_bmanuel/' . MODULO . DELETE_USER . '/',
        'EDIT' => '/dwp_2023_pf_bmanuel/' . MODULO . EDIT_USER . '/'
    )
);
